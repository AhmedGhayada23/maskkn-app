...
class AddPropertyStepFour extends StatefulWidget {
  const AddPropertyStepFour({super.key});

  @override
  State<AddPropertyStepFour> createState() => _AddPropertyStepFourState();
}

class _AddPropertyStepFourState extends State<AddPropertyStepFour> {
  File? image;
  XFile? _pickedFile;
