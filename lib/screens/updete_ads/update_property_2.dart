...
import 'update_property_3.dart';

class UpdatePropertyStepTwo extends StatefulWidget {
  const UpdatePropertyStepTwo({super.key});
  @override
  State<UpdatePropertyStepTwo> createState() => _UpdatePropertyStepTwoState();
}

class _UpdatePropertyStepTwoState extends State<UpdatePropertyStepTwo> {
  double? landSize;
  double? buildingSize;
  double? price;
  ...
  Future<void> beadroomAndBathroom() async {
    var provider = Provider.of<ListPropertyProvider>(context);
    setState(() {
      bedroom_num = provider.bedrooms;
      bathroom_num = provider.bathrooms;
      builtYear = provider.builtYear.toString();
      MaidIsChecked = provider.maidRoom != '0' ? true : false;
      LaundryIsChecked = provider.laundryRoom != '0' ? true : false;
    });
  }
            ...
            children: [
              ...
              Consumer<ListPropertyProvider>(
                builder: (context, value, child) {
                  priceController = TextEditingController(text: value.price);
              ...
              Consumer<ListPropertyProvider>(
                  builder: (_, ListProperty, child) => ListProperty
                                  .sectorDetailSlug ==
                              'land' ||
                          ListProperty.propertyType == 'flat' ||
                          ListProperty.propertyType == 'shop' ||
                          ListProperty.propertyType == 'office' ||
                          ListProperty.propertyType == 'store'
                      ? Container()
                      : Container(
                          child: Column(
                            children: [
              ...
              ARProvider.sectorDetailSlug == "land" ||
                  ...
                  ? Consumer<ListPropertyProvider>(
                      builder: (context, value, child) {
                        areaController =
                            TextEditingController(text: value.areaSize);
                        return TextFormField(
              ...
              ARProvider.sectorDetailSlug == "villa" ||
                  ...
                  ? Consumer<ListPropertyProvider>(
                      builder: (context, value, child) {
                        buildingController =
                            TextEditingController(text: value.buildingSize);
                        return TextFormField(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => UpdatePropertyStepThree(
                            id: int.parse(ARProvider.governorate),
                            setFeatures: ARProvider.features),
                      ),
                    );
                  },
                ),
