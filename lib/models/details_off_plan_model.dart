class DetailsOffPlanModel {
  ...
  DetailsOffPlanModel.fromJson(Map<String, dynamic> json) {
    if (json["id"] is int) {
      id = json["id"];
    }
    ...
    if (json["last_hour_views"] is String) {
    ...
    if (json["off_plans"] is List) {
      offPlans = json["off_plans"] == null
          ? null
          : (json["off_plans"] as List)
              .map((e) => OffPlans.fromJson(e))
              .toList();
    }
  }
  ...
  Media1.fromJson(Map<String, dynamic> json) {
    ...
    if (json["generated_conversions"] is Map) {
      generatedConversions = json["generated_conversions"] == null
          ? null
          : GeneratedConversions1.fromJson(json["generated_conversions"]);
    }
