class AgentModel{
  ...
  dynamic billing;
  int? totalPaid;
  List<PropertiesForSale>? propertiesForSale;
  List<PropertiesForRent>? propertiesForRent;
  List<dynamic>? agents;
  List<Media4>? media;

  AgentModel({this.id, this.name, this.email, this.phone, this.status, this.website, this.description, this.stateId, this.cityId, this.propertiesCount, this.avatar, this.role, this.activePackage, this.billing, this.totalPaid, this.propertiesForSale, this.propertiesForRent, this.agents, this.media});
  ...
  AgentModel.fromJson(Map<String, dynamic> json) {
    ...
    if(json["properties_for_sale"] is List) {
      propertiesForSale = json["properties_for_sale"] == null ? null : (json["properties_for_sale"] as List).map((e) => PropertiesForSale.fromJson(e)).toList();
    }
    if(json["properties_for_rent"] is List) {
      propertiesForRent = json["properties_for_rent"] == null ? null : (json["properties_for_rent"] as List).map((e) => PropertiesForRent.fromJson(e)).toList();
    }
    if(json["agents"] is List) {
      agents = json["agents"] ?? [];
    }
    if(json["media"] is List) {
      media = json["media"] == null ? null : (json["media"] as List).map((e) => Media4.fromJson(e)).toList();
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if(propertiesForSale != null) {
      _data["properties_for_sale"] = propertiesForSale?.map((e) => e.toJson()).toList();
    }
    if(propertiesForRent != null) {
      _data["properties_for_rent"] = propertiesForRent?.map((e) => e.toJson()).toList();
    }
    if(agents != null) {
      _data["agents"] = agents;
    }
...
class Media4 {
  ...
  GeneratedConversions4? generatedConversions;
  ...
  Media4({this.id, this.modelType, this.modelId, this.uuid, this.collectionName, this.name, this.fileName, this.mimeType, this.disk, this.conversionsDisk, this.size, this.manipulations, this.customProperties, this.generatedConversions, this.responsiveImages, this.orderColumn, this.createdAt, this.updatedAt, this.originalUrl, this.previewUrl});

  Media4.fromJson(Map<String, dynamic> json) {
    if(json["id"] is int) {
      id = json["id"];
    }
    ...
    if(json["generated_conversions"] is Map) {
      generatedConversions = json["generated_conversions"] == null ? null : GeneratedConversions4.fromJson(json["generated_conversions"]);
    }
...
class GeneratedConversions4 {
  bool? thumb;
  bool? small;
  bool? medium;
  bool? large;

  GeneratedConversions4({this.thumb, this.small, this.medium, this.large});

  GeneratedConversions4.fromJson(Map<String, dynamic> json) {
...
class PropertiesForRent {
  ...
  PropertiesForRent({this.id, this.titleEn, this.titleAr, this.url3D, this.url360, this.descriptionEn, this.descriptionAr, this.slug, this.locationLong, this.locationLat, this.countryId, this.stateId, this.sectorId, this.sectorDetailId, this.area, this.parking, this.laundryRoom, this.maidRoom, this.numberBathrooms, this.yearBuilt, this.numberRooms, this.cityId, this.numberBedrooms, this.numberBeds, this.buildingSize, this.videoType, this.videoUrl, this.landingSize, this.square, this.isFeatured, this.autoRenew, this.isSale, this.salePrice, this.isRent, this.rentPrice, this.neverExpired, this.rentPeriod, this.numberFloors, this.listingStatus, this.expireDate, this.userId, this.isOffPlan, this.buildingCompleted, this.createdAt, this.updatedAt, this.financeMonths, this.offPlansCount, this.small, this.medium, this.createdTime, this.updatedTime, this.views, this.lastHourViews, this.clicks, this.user, this.media});

  PropertiesForRent.fromJson(Map<String, dynamic> json) {
    if(json["id"] is int) {
      id = json["id"];
    }
    ...
    if(json["offPlans_count"] is int) {
      offPlansCount = json["offPlans_count"];
    }
    ...
    if(json["media"] is List) {
      media = json["media"] == null ? null : (json["media"] as List).map((e) => Media3.fromJson(e)).toList();
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    _data["offPlans_count"] = offPlansCount;
    _data["small"] = small;
    _data["medium"] = medium;
...
class Media3 {
  ...
  List<dynamic>? manipulations;
  List<dynamic>? customProperties;
  GeneratedConversions3? generatedConversions;
  List<dynamic>? responsiveImages;
  int? orderColumn;
  String? createdAt;
  String? updatedAt;
  ...
  Media3({this.id, this.modelType, this.modelId, this.uuid, this.collectionName, this.name, this.fileName, this.mimeType, this.disk, this.conversionsDisk, this.size, this.manipulations, this.customProperties, this.generatedConversions, this.responsiveImages, this.orderColumn, this.createdAt, this.updatedAt, this.originalUrl, this.previewUrl});

  Media3.fromJson(Map<String, dynamic> json) {
    if(json["id"] is int) {
      id = json["id"];
    }
    if(json["model_type"] is String) {
    ...
    if(json["generated_conversions"] is Map) {
      generatedConversions = json["generated_conversions"] == null ? null : GeneratedConversions3.fromJson(json["generated_conversions"]);
    }
    if(json["responsive_images"] is List) {
      responsiveImages = json["responsive_images"] ?? [];
    }
...
class GeneratedConversions3 {
  bool? thumb;
  bool? small;
  bool? medium;
  bool? large;

  GeneratedConversions3({this.thumb, this.small, this.medium, this.large});

  GeneratedConversions3.fromJson(Map<String, dynamic> json) {
    if(json["thumb"] is bool) {
      thumb = json["thumb"];
    }
    if(json["small"] is bool) {
...
class User1 {
  ...
  User1({this.id, this.name, this.avatar, this.role, this.activePackage, this.billing, this.totalPaid, this.media});
  ...
  User1.fromJson(Map<String, dynamic> json) {
    ...
    if(json["media"] is List) {
      media = json["media"] == null ? null : (json["media"] as List).map((e) => Media2.fromJson(e)).toList();
    }
  }
...
class Media2 {
  ...
  List<dynamic>? manipulations;
  List<dynamic>? customProperties;
  GeneratedConversions2? generatedConversions;
  List<dynamic>? responsiveImages;
  int? orderColumn;
  String? createdAt;
  String? updatedAt;
  ...
  Media2({this.id, this.modelType, this.modelId, this.uuid, this.collectionName, this.name, this.fileName, this.mimeType, this.disk, this.conversionsDisk, this.size, this.manipulations, this.customProperties, this.generatedConversions, this.responsiveImages, this.orderColumn, this.createdAt, this.updatedAt, this.originalUrl, this.previewUrl});
  ...
  Media2.fromJson(Map<String, dynamic> json) {
    ...
    if(json["generated_conversions"] is Map) {
      generatedConversions = json["generated_conversions"] == null ? null : GeneratedConversions2.fromJson(json["generated_conversions"]);
    }
    if(json["responsive_images"] is List) {
      responsiveImages = json["responsive_images"] ?? [];
    }
...
class GeneratedConversions2 {
  bool? thumb;
  bool? small;
  bool? medium;
  bool? large;

  GeneratedConversions2({this.thumb, this.small, this.medium, this.large});

  GeneratedConversions2.fromJson(Map<String, dynamic> json) {
    if(json["thumb"] is bool) {
      thumb = json["thumb"];
    }
    if(json["small"] is bool) {
...
class PropertiesForSale {
  ...
  PropertiesForSale({this.id, this.titleEn, this.titleAr, this.url3D, this.url360, this.descriptionEn, this.descriptionAr, this.slug, this.locationLong, this.locationLat, this.countryId, this.stateId, this.sectorId, this.sectorDetailId, this.area, this.parking, this.laundryRoom, this.maidRoom, this.numberBathrooms, this.yearBuilt, this.numberRooms, this.cityId, this.numberBedrooms, this.numberBeds, this.buildingSize, this.videoType, this.videoUrl, this.landingSize, this.square, this.isFeatured, this.autoRenew, this.isSale, this.salePrice, this.isRent, this.rentPrice, this.neverExpired, this.rentPeriod, this.numberFloors, this.listingStatus, this.expireDate, this.userId, this.isOffPlan, this.buildingCompleted, this.createdAt, this.updatedAt, this.financeMonths, this.offPlansCount, this.small, this.medium, this.createdTime, this.updatedTime, this.views, this.lastHourViews, this.clicks, this.user, this.media});

  PropertiesForSale.fromJson(Map<String, dynamic> json) {
    if(json["id"] is int) {
      id = json["id"];
    }
    titleEn = json["title_en"];
